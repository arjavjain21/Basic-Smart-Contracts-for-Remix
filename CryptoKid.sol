...
// A basic program using different functionalities available in solidity, to transfer Balance from a parent's wallet to a kid's wallet
// Isn't gas efficient for too many kids. Written to explore and understand the different features of solidity/
